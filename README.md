...
Simulator checks do not require Apple signing credentials. For a physical device or TestFlight, follow the [personal signing and access instructions](docs/RELEASING.md#personal-signing-on-a-new-mac). Never use an employer's signing team for this project.
