...
Pass CI and the simulator suite. Then check a physical iPhone: tapping and dragging, large text/VoiceOver, safe areas, calls/backgrounding, offline cold start, saved progress after relaunch, native share sheet, privacy choice and UTC day rollover. Check the supported iPad orientations too. Simulators cannot establish all physical-device behavior or guarantee App Review approval.
