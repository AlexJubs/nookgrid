...
def package(platform="itch"):
    ...
    files["index.html"] = replace_once(files["index.html"], r'<p id="analytics-description"[^>]*>.*?</p>', '<p id="analytics-description">This itch.io build does not collect play analytics.</p>')
